...
class EditNoteActivity : AppCompatActivity(), NoteDialogFragment.DialogListener {
    ...
    private fun deleteNote(mNote:NoteEntity){
        ...
        call= NoteApiClient.build()?.deleteNote(NoteConstant.APPLICATIONID, NoteConstant.RESTAPIKEY,map,mNote.objectId)
    ...
    private fun editNote(){
       ...
       call= NoteApiClient.build()?.updateNote(NoteConstant.APPLICATIONID, NoteConstant.RESTAPIKEY,map,noteId,raw)
